...
# data files (PDF, the two HTML files, JSON mirror, rendered pages) live in the
# repo root; the scripts were relocated into scripts/ but the data was not.
DATA_DIR    = os.path.dirname(SCRIPT_DIR)
PDF         = os.path.join(DATA_DIR, "Thirumanthiram_English_Natarajan_Archive.pdf")
HTML_FILES  = [os.path.join(DATA_DIR, "index.html"),
               os.path.join(DATA_DIR, "flipbook.html")]
JSON_MIRROR = os.path.join(DATA_DIR, "thirumanthiram_verses.json")
PAGES_DIR   = os.path.join(DATA_DIR, "_pages")
